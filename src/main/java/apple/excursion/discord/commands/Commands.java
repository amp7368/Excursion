...
public enum Commands {
    ...
    COMMAND_HISTORY(Collections.singletonList("history"), "Gives a history with intervals of the specified time", "[(optional) -m [months]] [(optional) -w [weeks]] [(optional) -d [days]]", new CommandGuildHistory()),
