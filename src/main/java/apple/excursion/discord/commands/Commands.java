...
public enum Commands {
    ...
    LEADERBOARD_IN_GUILD(Arrays.asList("gleaderboard", "glb"), "Gives a leaderboard for a specific guild or the overall guild leaderboard", "[(optional) tag/name]", new CommandGuild()),
