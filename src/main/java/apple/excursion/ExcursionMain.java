...
public class ExcursionMain {
    private static final String APPLICATION_NAME = "ExcursionBot";
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = ExcursionMain.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
